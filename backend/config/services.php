...
return [
    'payment' => [
        ...
        'success_url' => env('FRONTEND_PAYMENT_SUCCESS_URL', 'http://localhost:5173/payment/success'),
        'cancel_url' => env('FRONTEND_PAYMENT_CANCEL_URL', 'http://localhost:5173/payment/cancelled'),
    ],
